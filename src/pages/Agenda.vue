    ...
    return {
      ...
      activity: [
        ...
        },
        {
          ...
          disable: false,
          summary: '大地遊戲為 2018 年特殊活動，報到後領取小貓袋，內附一張名牌，根據名牌背面九宮格內的編號提示前往指定攤位，完成攤位挑戰即可得到攤位一點。<br><br>收集完同一格內的點數，即完成該格，以斜、橫、豎相連的三格成一線，完成五條線以上 (不含五條 ) 即可前往 SITCON 攤位換取限量贈品！<br><br>事不宜遲，趕快來挑戰吧！'
        }
      ]
    }
  },
